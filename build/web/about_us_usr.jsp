<%-- 
    Document   : about_us_usr
    Created on : 14 Feb, 2014, 10:53:30 AM
    Author     : Nishant
--%>
			...
			<header>
				...
				<nav id="menu">
					<ul>
						...
						<li class="nav2" id="active"><a href="about_us_usr.jsp">ABOUT Us</a></li>
		...
		<div class="body6">
			<div class="main">
				<div class="wrapper">
					...
					<h2>The Latest  About <span>Our Site</span></h2>
                                        <table><tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tr>
                                                <tr>
	...
	<div class="body7">
		<div class="main">
			<section id="content">
					...
					<article class="col2">
						<div class="pad1"><br/><br/>
							...
							<div class="wrapper">
								...
								<div class="cols">
									<p>
									Our Vision is to be the first-choice provider of maintenance, repair, and improvement solutions for home and business. </p>
								</div>
							</div>
							<div class="wrapper">
								<figure class="left"><img src="images/marker_1.gif" alt=""></figure>
								<div class="cols">
									<p>
									Handyman is the solution for all your household chores; no matter how small, it's always: On time. Done right.®</p>
								</div>
							</div>
				...
				<div class="wrapper">
				  <article class="col1 pad_left1"></article>
				</div>
			</section>
		</div>
	</div>
