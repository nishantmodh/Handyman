<%-- 
    Document   : offer_adm
    Created on : 26 Feb, 2014, 12:52:40 PM
    Author     : Nishant
--%>
		...
		<div class="main">
			<section id="content">
						...
						<div class="pad1">
							...
							<h2>Add Offer:</h2>
                                                        <form id="ContactForm" name="fm1" action="offer_adm">
                                                            
								<div>
									<div  class="wrapper">
										<strong>Offer ID:</strong><br/>
										<div class="bg"><input type="text" class="input" name="oid"></div>
									</div>
                                                                        <div  class="wrapper">
...
%> 
									...
									<div  class="wrapper">
										Offer Type:<br/>
										<div class="bg"><input type="text" class="input" name="otype" >	</div>							
									</div>
                                                                       
                                                                    <div  class="textarea_box">
										Offer Description:<br/>
										<div class="bg"><textarea name="desc" cols="1" rows="1"></textarea>	</div>						
									</div>
                                                                     <div  class="wrapper">
										<strong>Offer Cost:</strong><br/>
                                                                                Rs. <div class="bg"><input type="text" class="input" name="cost" >	</div>	 
                                        						
									</div>
                                                                    <div  class="wrapper">
										<strong>Start Date:</strong><br/>
                                                                                <div class="bg"><input type="text" class="input" name="sdate">	</div>	 
                                        						
									</div>
                                                                    <div  class="wrapper">
										<strong>End Date:</strong><br/>
                                                                                <div class="bg"><input type="text" class="input" name="edate">	</div>	 
