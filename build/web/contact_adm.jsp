<%-- 
    Document   : contact_adm
    Created on : 16 Apr, 2014, 11:23:24 AM
    Author     : Nishant
--%>
			...
			<div class="main">
				<div class="wrapper">
                                     <div>
                                        <table>
                                                <tr>
                                                    <td><strong><a href="feedback_adm.jsp">Complain Box</a></strong></td>
                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    <td id="active"><strong><a href="contact_adm.jsp">Contact Box</a></strong></td>
                                                </tr>
                                            </table>
                                        </div>
	...
	<div class="body7">
		<div class="main">
			<section id="content">
						...
						<div class="pad1">
                                                     <div class="main">
                                                        <h2>Check Contact Information:</h2><br/>
...
Statement st=cn.createStatement();
              String f="select * from contact where status='pending'";  
...
<tr>
    ...
    <td><center><a href="cn_adm.jsp?k=<%=rs2.getInt(1)%>"> Solved</a></center> </td>
              </tr>
