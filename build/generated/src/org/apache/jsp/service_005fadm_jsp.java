...
public final class service_005fadm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(session.getAttribute("usr")==null)
    {
      ...
      out.write("        \r\n");
      out.write("        var a=document.frm1.sid.value;\r\n");
      out.write("        if(a==\"\"){\r\n");
      ...
      out.write("                                        <table>\r\n");
      out.write("                                                <tr>\r\n");
      out.write("                                                    <td id=\"active\"><a href=\"service_adm.jsp\"><strong>Add Service</a>&nbsp;&nbsp;&nbsp;</strong></td>\r\n");
      out.write("                                                    \r\n");
      ...
      out.write("                                           \r\n");
      out.write("                                        </div>\r\n");
      out.write("\t\t\t\t\t\t\t<h2>Add Services:</h2>\r\n");
      out.write("                                                        <form id=\"ContactForm\" name=\"frm1\" onsubmit=\"return fn()\" action=\"service_adm\">\r\n");
      out.write("                                                            \r\n");
      out.write("\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div  class=\"wrapper\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                                                                    <div  class=\"wrapper\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tService Icon:<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"bg\"><input type=\"file\" name=\"icon\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div  class=\"wrapper\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tService Type:<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"bg\"><input type=\"text\" class=\"input\" name=\"stype\" >\t</div>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                                                                       \r\n");
      out.write("                                                                    <div  class=\"textarea_box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tService Description:<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"bg\"><textarea name=\"descript\" cols=\"1\" rows=\"1\"></textarea>\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                                                                    <div  class=\"wrapper\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tService Image:<br/>\r\n");
      out.write("                                                                                <div class=\"bg\"><input type=\"file\" class=\"input\" name=\"s_im\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("                                                                     <br/><br/>\r\n");
